      ...
      <div className="lijstPaneel">
        ...
        <div className={styles.tabelScroll}>
          <table>
            <thead>
              <tr>
                <th style={{ width: 96 }}>LARA ID</th>
                <th style={{ width: 110 }}>Designator</th>
                {/* Alleen Notitie staat vrij: de overgebleven ruimte van een breed
                    scherm gaat naar de laatste kolom, niet naar de naam. Zonder
                    breedte op Naam kwam die op een monitor van 2000px op ruim
                    900px uit, met de rest samengedrukt aan de rechterkant. */}
                <th style={{ width: 340 }}>Naam</th>
            ...
            <tbody>
              {zichtbaar.map((rij) => (
                <tr
                  key={rij.airspaceId}
                  data-selected={rij.airspaceId === detail.gekozen}
                  onClick={() => detail.kies(rij.airspaceId)}
                  className={styles.rij}
                >
                  {/* Het nummerveld en de verwijderknop vangen hun eigen klik af:
                      daar wil je nummeren of weghalen, geen detail openen. */}
