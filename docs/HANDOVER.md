...
8. ~~**Export**~~ — **klaar.** [`lib/laraWorkbook.ts`](../lib/laraWorkbook.ts) (spec-conform, drie werkbladen), [`lib/laraTimesheets.ts`](../lib/laraTimesheets.ts), [`lib/kmlExport.ts`](../lib/kmlExport.ts), [`lib/exportBevindingen.ts`](../lib/exportBevindingen.ts), drie downloadroutes en scherm 4. Gedraaid op het echte AeroDB-bestand: 922 gebieden in 8,7 s geparsed, werkboek in 43 ms.
